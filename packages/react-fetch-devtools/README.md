...
Fetch observation and error simulation devtools panel
...
```javascript
import { Component } from "@watcha-authentic/react-fetch-devtools";
import "@watcha-authentic/react-fetch-devtools/style.css";
```
