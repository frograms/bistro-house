...
로컬 카나리 배포는 `pnpm publish:canary`, patch 배포는 `bash ./project-attachment/package/publish-patch.sh` (각각 `npm login`).
...
# 로컬 (auth: login)
npm login
bash ./project-attachment/package/publish-patch.sh react-slider
