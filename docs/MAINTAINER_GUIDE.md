...
| [PLAYGROUND_EXAMPLE_GUIDE.md](./PLAYGROUND_EXAMPLE_GUIDE.md)                                                                  | playground 패키지 예제 추가 기준                        |
...
2. [PLAYGROUND_EXAMPLE_GUIDE.md](./PLAYGROUND_EXAMPLE_GUIDE.md) — playground 예제 추가
3. [PACKAGE_README_GUIDE.md](./PACKAGE_README_GUIDE.md) — 외부 README
4. [PACKAGE_DEPS_AND_BUILD.md](./PACKAGE_DEPS_AND_BUILD.md) — deps / peer / tsdown
